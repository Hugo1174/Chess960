...
template <> constexpr inline auto NetworkManager::qt_create_metaobjectdata<qt_meta_tag_ZN14NetworkManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'promotionChoiceReceived'
        QtMocHelpers::SignalData<void(PieceType)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->promotionChoiceReceived((*reinterpret_cast< std::add_pointer_t<PieceType>>(_a[1]))); break;
        case 2: _t->opponentDisconnected(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NetworkManager::*)(const Move & )>(_a, &NetworkManager::moveReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetworkManager::*)(PieceType )>(_a, &NetworkManager::promotionChoiceReceived, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (NetworkManager::*)()>(_a, &NetworkManager::opponentDisconnected, 2))
            return;
    }
}
...
// SIGNAL 1
void NetworkManager::promotionChoiceReceived(PieceType _t1)
{
